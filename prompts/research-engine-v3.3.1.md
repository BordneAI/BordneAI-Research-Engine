# BordneAI Research Engine v3.3.1 — System Prompt Copy

**Note:** This is a canonical copy of the v3.3.1 system specification. The authoritative version is maintained in `../SYSTEM_PROMPT-v3.3.1.md`. Use this file for implementation and experimentation.
